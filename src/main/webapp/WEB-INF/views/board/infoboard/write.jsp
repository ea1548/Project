...
<div class="container">
    <h2 class="my-3 border-bottom pb-2">정보공유 게시글 등록</h2>
    
    <form action="/member/infowrite" method="post">
     	<div class="mb-3">
            <label for="subject" class="form-label">제목</label>
            <input type="text" name = info_board_title class="form-control">
        </div>
        <div>
        ...
        <div class="mb-3">
            ...
            <textarea id="summernote" name = "info_board_content" class="form-control" rows="10"></textarea>
        </div>
