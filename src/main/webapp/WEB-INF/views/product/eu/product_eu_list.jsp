...
<%@include file="/WEB-INF/views/include/nav.jsp" %>
   ...
   <div class= "kor1">
	  <c:forEach var="euImgList"  items="${ euImgList }">        
									
			 <div class= "image_wrap"
			  	
        		data-filename="${euImgList.fileName}"
				data-productnumber="${euImgList.product_number}"
			    data-path="${euImgList.uploadPath}" 
			    data-uuid="${euImgList.uuid}"
			    
			    >	
			   <img>
			   <a href="/product/eu/detail/eu_detail?product_number=${euImgList.product_number}">${euImgList.product_name}</a>
		       <div class = "price">
		       ${euImgList.product_price}
		       </div> 
		     </div>
